...
class NDMainCollectionViewCell: UICollectionViewCell {
  ...
  private var focusedFrame:CGRect = CGRect(x: 0.0, y: 0.0, width: 624.0, height: 554.0)
  ...
  private func createConstraints(){
    ...
    if titleLabelLeftAnchorConstraint == nil{
      //titleLabelTopAnchorConstraint = titleLabel.topAnchor.constraint(equalTo: imageView.bottomAnchor, constant: 17.0)
